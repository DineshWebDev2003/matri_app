                    ...
                    <div class="login__wrapper">
                        <div class="section__head text-center">
                            ...
                            <p class="t-short-para mx-auto text-center mb-0">
                                @php
                                    $subheading = __(@$loginContent->data_values->subheading);
                                    $highlight = 'username and password';
                                    $highlighted = str_replace(
                                        $highlight, 
                                        '<span style="color: #ff6b6b;">' . $highlight . '</span>', 
                                        $subheading
                                    );
                                    echo $highlighted;
                                @endphp
                            ...
                            <div class="row">
                                <div class="col-sm-12 mt-0">
                                    <div class="input--group">
                                        <input class="form-control form--control" id="email" name="email" required type="email" value="{{ old('email') }}">
