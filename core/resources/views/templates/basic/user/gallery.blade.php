        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-info" role="alert">
                    @php
                        $expiry = $user->limitation->expired_at ?? $user->limitation->expire_date;
                    @endphp
                    @if (!checkValidityPeriod($user->limitation))
                        <p class="mb-0">@lang('Your package has been expired') <span class="fw-600">{{ $expiry ? showDateTime($expiry, 'd M, Y') : '' }}</span></p>
                    @else
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 grid-item" data-category="1" data-sort="value">
                    <div class="profile-gallery position-relative">
                        ...
                        <div class="profile-gallery__thumb">
                            <img src="{{ asset('assets/images/user/gallery/' . $userImage->image) }}" alt="">
                            <div class="profile-gallery__icon">
                                <a class="magnific-gallery" href="{{ asset('assets/images/user/gallery/' . $userImage->image) }}"><i class="fas fa-search-plus"></i> </a>
