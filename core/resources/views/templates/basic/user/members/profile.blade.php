                                ...
                                @if ($user->id != $member->id)
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <h2 class="accordion-header" id="panelsStayOpen-contactDetails">
                                            <button class="accordion-button contact-detail contact-details-animated @if (!$exist) collapsed @endif" data-bs-target="#panelsStayOpen-collapseContactDetails" data-permit="{{ $exist ? 1 : 0 }}" type="button" aria-controls="panelsStayOpen-collapseContactDetails" aria-expanded="{{ $exist ? 'true' : 'false' }}" @if ($exist) data-bs-toggle="collapse" @endif>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('user.contact.view') }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        @else
                            <div class="text-center">
                                <p class="fw-bold mb-3">@lang('Please upgrade Package to View Contacts')</p>
                                <a href="{{ route('packages') }}" class="btn btn--base">@lang('Upgrade Package')</a>
                            </div>
                        @endif
                    </div>
