                            ...
                            <div class="row gy-4">
                                <div class="col-sm-12">
                                    <div class="input--group">
                                        ...
                                        <label class="form--label">Face Colour</label>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="input--group">
                                        <input class="form-control form--control" min="0" name="height" step="any" type="number" value="{{ old('height') }}">
                                        <label class="form--label">@lang('Height')</label>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="input--group">
                                        <input class="form-control form--control" min="0" name="weight" step="any" type="number" value="{{ old('weight') }}">
                                ...
                                <div class="col-sm-12">
                                    <div class="input--group">
                                        <input class="form-control form--control" name="eye_color" type="text" value="{{ old('eye_color') }}">
                                        <label class="form--label">@lang('Eye Color')</label>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="input--group">
                                        <input class="form-control form--control" name="hair_color" type="text" value="{{ old('hair_color') }}">
