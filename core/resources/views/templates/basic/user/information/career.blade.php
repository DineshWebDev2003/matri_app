                                    ...
                                    <div class="row main-form-body g-4">
                                        <div class="col-sm-12">
                                            <div class="input--group">
                                                <input class="form-control form--control" name="company[{{ $key }}]" type="text" value="{{ old('company')[$key] }}">
                                                <label class="form--label">@lang('Company')</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="input--group">
                                                <input class="form-control form--control" name="designation[{{ $key }}]" type="text" value="{{ old('designation')[$key] }}">
                                                <label class="form--label">@lang('Designation')</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="input--group">
                                                <input class="datepicker-here form-control form--control" name="start[{{ $key }}]" data-date-format="yyyy" data-language='en' data-min-view="years" data-position='top left' data-view="years" type="number" value="{{ old('start')[$key] }}">
                            ...
                            @empty
                                <div class="form--area mb-3 border px-4 py-4">
                                    <div class="row main-form-body g-4">
                                        <div class="col-sm-12">
                                            <div class="input--group">
                                                <input class="form-control form--control" name="company[0]" type="text" placeholder=" ">
                                                <label class="form--label">@lang('Company')</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="input--group">
                                                <input class="form-control form--control" name="designation[0]" type="text">
                                                <label class="form--label">@lang('Designation')</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="input--group">
                                                <input class="datepicker-here form-control form--control" name="start[0]" data-date-format="yyyy" data-language='en' data-min-view="years" data-position='top left' data-view="years" type="number">
                                                <label class="form--label">@lang('Starting Year')</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
        ...
        function educationForm() {
            ...
            <div class="form--area border mb-3 px-4 py-4">
                ...
                <div class="row main-form-body g-4">
                    <div class="col-sm-12">
                        <div class="input--group">
                            <input placeholder=" " type="text" name="company[]" class="form-control form--control">
                            <label class="form--label">@lang('Company')</label>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="input--group">
                            <input placeholder=" " type="text" name="designation[]" class="form-control form--control">
                            <label class="form--label">@lang('Designation')</label>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="input--group">
                            ...
                            data-view="years" data-date-format="yyyy" data-position='top left'>
                            <label class="form--label">@lang('Starting Year')</label>
                        </div>
                    </div>
                    <div class="col-sm-6">
