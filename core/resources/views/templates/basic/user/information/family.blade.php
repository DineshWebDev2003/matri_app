                            ...
                            <div class="row gy-4">
                                <div class="col-sm-12">
                                    <div class="input--group">
                                        <input class="form-control form--control" name="father_name" type="text" value="{{ old('father_name') }}">
                                ...
                                <div class="col-sm-12">
                                    <div class="input--group">
                                        <input class="form-control form--control" name="mother_name" type="text" value="{{ old('mother_name') }}">
