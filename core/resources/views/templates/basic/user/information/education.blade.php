                                    ...
                                    <div class="row main-form-body">
                                        <div class="col-sm-6">
                                            <div class="input--group">
                                                <input class="form-control form--control" name="institute[{{ $key }}]" type="text" value="{{ old('institute')[$key] }}" placeholder="">
                                                <label class="form--label">@lang('Institute')</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="input--group">
                                                <input class="form-control form--control" name="degree[{{ $key }}]" type="text" value="{{ old('degree')[$key] }}" placeholder="">
                                        ...
                                        <div class="col-sm-6 mt-4">
                                            <div class="input--group">
                                                <input class="form-control form--control" name="field_of_study[{{ $key }}]" type="text" value="{{ old('field_of_study')[$key] }}" placeholder="">
                                        ...
                                        <div class="col-sm-6 mt-4">
                                            <div class="input--group">
                                                <input class="datepicker-here form-control form--control" name="start[{{ $key }}]" data-date-format="yyyy" data-language="en" data-min-view="years" data-position="top left" data-view="years" type="number" value="{{ old('start')[$key] }}" placeholder="">
                            ...
                            @empty
                                <div class="form--area mb-3 border px-4 py-4">
                                    <div class="row main-form-body">
                                        <div class="col-sm-6">
                                            <div class="input--group">
                                                <input class="form-control form--control" name="institute[0]" type="text" placeholder="">
                                                <label class="form--label">@lang('Institute')</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="input--group">
                                                <input class="form-control form--control" name="degree[0]" type="text" placeholder="">
                                                <label class="form--label">@lang('Degree')</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 mt-4">
                                            <div class="input--group">
                                                <input class="form-control form--control" name="field_of_study[0]" type="text" placeholder="">
                                                <label class="form--label">@lang('Field Of Study')</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 mt-4">
                                            <div class="input--group">
                                                <input class="datepicker-here form-control form--control" name="start[0]" data-date-format="yyyy" data-language="en" data-min-view="years" data-position="top left" data-view="years" type="number" placeholder="">
                                                <label class="form--label">@lang('Starting Year')</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 mt-4">
