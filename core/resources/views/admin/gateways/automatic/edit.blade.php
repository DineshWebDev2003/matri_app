...
@section('panel')
    <div class="row">
                                        ...
                                        @foreach ($gateway->extra as $key => $param)
                                            <div class="form-group col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control" readonly type="text" value="{{ $param->value }}" />
        ...
        @php
            $label = is_object($param) && property_exists($param,'title') ? $param->title : ucwords(str_replace('_',' ',$key));
            $val   = is_object($param) && property_exists($param,'value') ? $param->value : (is_scalar($param) ? $param : '');
        @endphp
                                        <div class="form-group col-lg-6">
                                            <label>{{ __($label) }}</label>
                                            <input class="form-control" name="global[{{ $key }}]" required type="text" value="{{ $val }}" />
                                        </div>
                                    @endforeach
                                </div>
                            </div>
