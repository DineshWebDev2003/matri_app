    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                @admincan('user-attributes.view')
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a class="{{ menuActive(['admin.religion.all', 'admin.caste.all', 'admin.blood.group.all', 'admin.marital.status.all'], 3) }}" href="javascript:void(0)">
                        <i class="menu-icon las la-user-cog"></i>
                        <span class="menu-title">@lang('User Attributes')</span>
                    </a>
                    <div class="sidebar-submenu {{ menuActive(['admin.religion.all', 'admin.caste.all', 'admin.blood.group.all', 'admin.marital.status.all'], 2) }}">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.caste.all') }}">
                                <a class="nav-link" href="{{ route('admin.caste.all') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Caste')</span>
                                </a>
                            </li>
...
@endadmincan
                            @admincan('users.active-paid.view')
                            <li class="sidebar-menu-item {{ menuActive('admin.users.active-to-paid') }}">
                                <a class="nav-link" href="{{ route('admin.users.active-to-paid') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Active Paid Members')</span>
                                </a>
                            </li>
@endadmincan
                            @admincan('users.expired.view')
                            <li class="sidebar-menu-item {{ menuActive('admin.users.expired') }}">
                                <a class="nav-link" href="{{ route('admin.users.expired') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Expired Members')</span>
                                </a>
                            </li>
@endadmincan
                            @admincan('users.change-membership.view')
                            <li class="sidebar-menu-item {{ menuActive('admin.users.change-plan-list') }}">
                                <a class="nav-link" href="{{ route('admin.users.change-plan-list') }}">
                                    <i class="menu-icon las la-exchange-alt"></i>
                                    <span class="menu-title">@lang('Change Membership')</span>
                                </a>
                            </li>
@endadmincan
                            @admincan('users.bulk-add.view')
                            <li class="sidebar-menu-item {{ menuActive('admin.users.bulk-add') }}">
                                <a class="nav-link" href="{{ route('admin.users.bulk-add') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Bulk User Add')</span>
                                </a>
                            </li>
                            @endadmincan
                            @admincan('users.followup.view')
                            <li class="sidebar-menu-item {{ menuActive('admin.users.followup.*') }}">
                                <a class="nav-link" href="{{ route('admin.users.followup.select-staff') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Follow-up Reports')</span>
                                </a>
                            </li>
@endadmincan
                            @admincan('users.gallery.view')
                            <li class="sidebar-menu-item {{ menuActive('admin.gallery.moderate') }}">
                                <a class="nav-link" href="{{ route('admin.gallery.moderate') }}">
...
@admincan('payment-gateways.view')
                <li class="sidebar-menu-item sidebar-dropdown">
...
@endadmincan
                ...
                @if($adminUser && $adminUser->can('payments.list'))
                <li class="sidebar-menu-item sidebar-dropdown">
