...
class ProfileController extends Controller
{
    ...
    private function basicInfo($request, $user)
    {
        $rules = [
            ...
            'gender'              => 'required|in:m,f,Male,Female,male,female',
        ...
        $messages = [
            ...
            'mother_tongue.max'            => 'Mother tongue max 100 characters',
        ...
        // top-level location columns for admin filters
        $basicInfo->country            = $request->pre_country;
        $basicInfo->state              = $request->pre_state;
        $basicInfo->city               = $request->pre_city;
        ...
        $basicInfo->permanent_address = [
            'country'  => $request->per_country ?: $request->pre_country,
            'state'    => $request->per_state ?: $request->pre_state,
            'zip'      => $request->per_zip ?: $request->pre_zip,
            'city'     => $request->per_city ?: $request->pre_city,
        ];
        $basicInfo->save();
    ...
    public function updateProfileImage(Request $request)
    {
        ...
        try {
            ...
            $notify[] = ['error', 'Upload failed: '.$exp->getMessage()];
        }
