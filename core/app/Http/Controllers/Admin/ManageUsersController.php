...
class ManageUsersController extends Controller
{
    ...
    protected function userData($scope = null)
    {
        ...
        // Eager load relations to avoid N+1 queries detected by laravel-query-detector
        $users->with('staff');
    ...
    public function detail($id)
    {
        ...
        ])->withCount('galleries as total_images')->findOrFail($id);
        ...
        // Fetch religion & caste for admin display
        $religion = optional($user->basicInfo)->religion_id ? optional(ReligionInfo::find($user->basicInfo->religion_id))->name : null;
        $caste    = optional($user->basicInfo)->caste;

        // Lists for form selects
        $religionsList = ReligionInfo::all();
        $castesList = CasteInfo::all();
    ...
    public function update(Request $request, $id)
    {
        ...
        // Update or create user's basic information
        $basicInfo = $user->basicInfo ?: new BasicInfo();
        ...
        $basicInfo->present_address = (object)[
            'address' => $request->address,
            'city'    => $request->city,
            'state'   => $request->state,
            'zip'     => $request->zip,
    ...
    public function showNotificationAllForm()
    {
        ...
        if (!$general->en && !$general->sn) {
            $notify[] = ['warning', 'Notification options are disabled currently'];
            return to_route('dashboard')->withNotify($notify);
        }
