...
interface InterestHeartProps {
  size?: number;
  filled?: boolean;
}

const InterestHeart: React.FC<InterestHeartProps> = ({ size = 24, filled = false }) => {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      <Defs>
        <RadialGradient id="heartGradient" cx="0.5" cy="0.5" r="0.8">
          <Stop offset="0%" stopColor="#FF0000" />
          <Stop offset="100%" stopColor="#DD2E44" />
        </RadialGradient>
      </Defs>
      ...
      {/* Main heart */}
      <Path 
        fill={filled ? "url(#heartGradient)" : "#DD2E44"} 
