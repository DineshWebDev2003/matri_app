...
const FemaleAvatar: React.FC<FemaleAvatarProps> = ({ size = 100, color = '#a196a6' }) => {
  return (
    <Svg
      height={size}
      width={size}
